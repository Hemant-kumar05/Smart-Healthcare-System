...
### **Version:** 1.0.0
### **Author:** Gowthamraj K (Modified by Hemant kumar)
...
2. Install and configure MySQL with root password: `@Hemant162`
...
```bash
cd "C:\Users\Hemant Kumar\Downloads\ST\Smart-Health-Care-System-main\SmartHealthcareSystem-Backend"
```
...
spring.datasource.password=@Hemant162
...
```bash
cd "C:\Users\Hemant Kumar\Downloads\ST\Smart-Health-Care-System-main\SmartHealthCareSystem-main"
```
...
```bash
cd "C:\Users\Hemant Kumar\Downloads\ST\Doctor"
```
...
2. Test database connection:
   ```bash
   mysql -u root -p@Hemant162 -e "SHOW DATABASES;"
   ```
...
### **Technical Support**
- **Primary Developer:** Hemant Kumar
- **Email:** hemant.healthcare@support.com
- **Project Location:** `C:\Users\Hemant Kumar\Downloads\ST\Smart-Health-Care-System-main\`
...
**Copyright © 2021-2025 Gowthamraj K & Hemant kumar**
